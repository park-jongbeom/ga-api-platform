-- AI 상담 서비스 초기 스키마 생성 (ai_consultant 스키마 사용)
-- 사용 조건: application.yml에서 flyway.schemas: ai_consultant 설정 필요

-- 스키마 설정
SET search_path TO ai_consultant, public;

-- pgvector 확장 활성화 (벡터 유사도 검색)
-- 주의: 이미 설치되어 있다면 주석 처리
