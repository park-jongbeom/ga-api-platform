package com.goalmond.matching.controller

import com.goalmond.matching.domain.dto.ApiResponse
import com.goalmond.matching.domain.dto.ErrorResponse
import com.goalmond.matching.domain.dto.MatchingResponse
import com.goalmond.matching.domain.dto.ProgramListResponse
import com.goalmond.matching.domain.dto.ProgramResponse
import com.goalmond.matching.domain.dto.SchoolResponse
...
class MockMatchingController {
    ...
    fun runMatching(@RequestBody request: MatchingRunRequest): ResponseEntity<ApiResponse<MatchingResponse>> {
        ...
        appendDebugLog(
            hypothesisId = "H1",
            location = "MockMatchingController.kt:runMatching.entry",
            message = "runMatching called",
            data = mapOf("userId" to request.userId)
        )
        // #endregion
        ...
        appendDebugLog(
            hypothesisId = "H2",
            location = "MockMatchingController.kt:runMatching.scenario",
            message = "scenario selected",
            data = mapOf("scenario" to scenario.name)
        )
        // #endregion
        ...
        appendDebugLog(
            hypothesisId = "H3",
            location = "MockMatchingController.kt:runMatching.exit",
            message = "runMatching response prepared",
            data = mapOf("totalMatches" to response.totalMatches)
        )
        // #endregion
    ...
    fun getLatestMatchingResult(): ResponseEntity<ApiResponse<MatchingResponse>> {
        ...
        appendDebugLog(
            hypothesisId = "H4",
            location = "MockMatchingController.kt:getLatestMatchingResult",
            message = "getLatestMatchingResult called",
            data = mapOf("hasCachedResult" to (lastMatchingResult != null))
        )
        // #endregion
    ...
    fun getPrograms(
        ...
        appendDebugLog(
            hypothesisId = "H5",
            location = "MockMatchingController.kt:getPrograms",
            message = "getPrograms called",
            data = mapOf("type" to type, "state" to state, "page" to page, "size" to size)
        )
        // #endregion
    ...
    fun getSchoolDetail(
        ...
        appendDebugLog(
            hypothesisId = "H6",
            location = "MockMatchingController.kt:getSchoolDetail",
            message = "getSchoolDetail called",
            data = mapOf("schoolId" to schoolId)
        )
        // #endregion
